      ...
      <main className="min-h-screen bg-white text-slate-900">
        ...
        <div className="border-b border-slate-100 bg-slate-50/50">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
            <div className="max-w-3xl">
              <div className="inline-flex items-center gap-2 px-3 py-1 mb-6 rounded-full bg-slate-100 border border-slate-200 text-slate-600 text-xs font-semibold uppercase tracking-wide">
              ...
              <h1 className="text-5xl md:text-6xl font-bold tracking-tight text-slate-900 mb-6">
                ...
                <span className="text-slate-400">modern professionals.</span>
              </h1>
        ...
        <div className="border-t border-slate-100 bg-slate-50">
          <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-24 text-center">
            ...
            <a href="#" className="inline-flex items-center justify-center px-6 py-3 rounded-lg bg-slate-900 text-white font-medium hover:bg-slate-800 transition-colors">
              Request a Tool
            </a>
          </div>
        </div>
