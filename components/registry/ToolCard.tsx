...
export function ToolCard({ tool, icon }: { tool: Omit<Tool, 'icon'>, icon: ReactNode }) {
    return (
        ...
        >
            <div
                className="group flex flex-col h-full p-5 bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 hover:border-slate-300 dark:hover:border-slate-700 transition-all duration-200 hover:shadow-lg hover:shadow-slate-200/50 dark:hover:shadow-black/50 hover:-translate-y-1"
            >
                <div className="flex items-start justify-between mb-4">
                    ...
                    <div className="flex items-center gap-2">
                        <FavoriteButton toolId={tool.slug} />
