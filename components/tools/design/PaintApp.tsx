...
export function PaintApp() {
    ...
    return (
        <div ref={wrapperRef} className={`flex flex-col gap-4 ${isFullscreen ? 'fixed inset-0 z-50 bg-slate-100 dark:bg-slate-950 p-4' : 'h-[calc(100vh-80px)] md:h-[calc(100vh-200px)] min-h-[500px]'}`}>
            {/* Toolbar */}
            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-3 md:p-4 flex flex-col md:flex-row flex-wrap items-start md:items-center gap-4 md:gap-6 shadow-sm overflow-x-auto md:overflow-visible">

                {/* Rows for mobile, Flex for desktop */}
                <div className="flex w-full md:w-auto flex-wrap gap-4 overflow-x-auto pb-2 md:pb-0 scrollbar-hide">
                    {/* Tools */}
                    <div className="flex items-center gap-1 md:gap-2 border-r border-slate-200 dark:border-slate-800 pr-4 md:pr-6 shrink-0">
                    ...
                    {/* Properties */}
                    <div className="flex items-center gap-4 border-r border-slate-200 dark:border-slate-800 pr-4 md:pr-6 shrink-0">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <input
                                ...
                                className="w-20 md:w-24 accent-slate-900 dark:accent-white"
                            />
                ...
                <div className="flex w-full md:w-auto items-center justify-between md:justify-end gap-4 ml-auto">
                    {/* Extras */}
                    <div className="flex items-center gap-3">
                        <button onClick={() => applyFilter('grayscale')} className="text-xs font-medium text-slate-600 dark:text-slate-400 hover:text-emerald-500 flex items-center gap-1">
                            <Wand2 className="w-3 h-3" /> <span className="hidden sm:inline">Gray</span>
                        </button>
                        <button onClick={() => applyFilter('invert')} className="text-xs font-medium text-slate-600 dark:text-slate-400 hover:text-emerald-500 flex items-center gap-1">
                            <Wand2 className="w-3 h-3" /> <span className="hidden sm:inline">Invert</span>
                        </button>
                        <label className="cursor-pointer text-xs font-medium text-slate-600 dark:text-slate-400 hover:text-emerald-500 flex items-center gap-1">
                            <UploadIcon className="w-3 h-3" /> <span className="hidden sm:inline">Upload</span>
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <button onClick={toggleFullscreen} className="p-2 text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 rounded-lg hidden sm:block" title={isFullscreen ? "Exit Fullscreen" : "Fullscreen"}>
                        ...
                        <button onClick={downloadImage} className="flex items-center gap-2 px-3 md:px-4 py-2 bg-emerald-500 hover:bg-emerald-600 text-white rounded-lg font-medium transition-colors ml-1 md:ml-2">
