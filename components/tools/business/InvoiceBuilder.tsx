...
import {
    ...
    CheckCircle2, AlertCircle, Save, Printer, Upload
} from 'lucide-react';
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="col-span-2">
                                    ...
                                    <textarea
                                        ...
                                        className="w-full px-4 py-3 bg-slate-50 dark:bg-slate-800 border-2 border-slate-100 dark:border-slate-700 rounded-xl focus:border-emerald-500 outline-none transition-all resize-none"
                                    />
                                </div>
                            </div>
                        </div>
